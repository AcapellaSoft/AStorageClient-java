...
/**
 * Запрос на поиск предыдущего ключа в дереве.
 */
public class DtPrevRequest implements RequestBase<DtPrevResponse>, ProtostuffSerializable {
     ...
     * @param key ключ
     */
    public DtPrevRequest(ByteArrayList treeName, ByteArrayList key) {
     ...
     * @return этот объект
     */
    public DtPrevRequest node(ByteArray node) {
        this.node = node;
        return this;
    }
     ...
     * @return этот объект
     */
    public DtPrevRequest transaction(long index) {
     ...
     * @return этот объект
     */
    public DtPrevRequest replicas(byte n, byte r, byte w) {
        this.n = n;
        this.r = r;
        this.w = w;
        return this;
    ...
    @Override
    public Supplier<DtPrevResponse> response() {
        return DtPrevResponse::new;
    }
}
